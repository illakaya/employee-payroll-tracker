...
const displayAverageSalary = function (employeesArray) {
    ...
    console.log(
        `The average employee salary between our ${employeesArray.length} employee(s) is \$${meanSalary.toFixed(2)}`
    );
};
...
const getRandomEmployee = function (employeesArray) {
    ...
    console.log(
        `Congratulations to ${employeesArray[num].firstName} ${employeesArray[num].lastName}, our random drawing winner!`
    );
};
